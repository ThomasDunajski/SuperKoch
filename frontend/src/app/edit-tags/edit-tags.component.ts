...
export class EditTagsComponent implements OnInit {
  ...
  categories = [
    { number: 10, name: 'Tageszeit' },
    { number: 20, name: 'Hauptzutat' },
    { number: 30, name: 'Eigenschaften' },
    { number: 40, name: 'Spezielle Diät' },
    { number: 50, name: 'Art der Mahlzeit' },
    { number: 60, name: 'Herkunft' },
  ];
      ...
      .then(
        (res) =>
          (this.tag = {
            name: '',
            clickCount: 0,
            category: { number: 0, name: 'not_Set' },
          })
      )
